...
// int digit1 = rndNum / 10; //делаем из двухзначного числа однозначное. берём только первое.
...
// Вариант 2
// char[] digits = numSintezator.Next(10, 100).ToString().ToCharArray(); //вторую часть преобразовали в строку и в массив.
// Console.WriteLine(digits);
// int digit1 = (int)digits[0] - 48; //Преобразовали в массив из двух симвоволов
// int digit2 = (int)digits[1] - 48;
// int resNum = digit1 > digit2 ? digit1 : digit2; //тернарный оператор
...
//в массив записали готовые ответы. и указываем на индекс ответа.
